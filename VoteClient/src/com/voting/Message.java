...
public class Message implements Serializable {
     ...
     * Types of messages
     */
    public static final byte REG = 0x0, INFO = 0x1, SHOW_CONF = 0x2,
	    CREATE_CONF = 0x3, JOIN_CONF = 0x4, KEY = 0x5, ENCRYPTED = 0x6,
	    CONFIRM_MEM = 0x7, EXIT_CONF = 0x8, VOTE = 0x9, START_VOTE = 0x10,
	    SHOW_STATE = 0x11, VOTE_RES = 0x12, ERROR = 0x13, UNKNOWN = 0x14;
    private byte type;
...
class Error extends Message {
     ...
     * Types of errors
     */
    public static final byte HANDSHAKE_ERROR = 0x0, DATABASE_ERROR = 0x1,
	    REGISTRATION_ERROR = 0x2, DOUBLE_CONNECTION = 0x3, BAN_ERROR = 0x4,
	    DECRYPT_ERROR = 0x5, INVALID_SIGNATURE = 0x6, CREATE_ERROR = 0x7,
	    JOIN_ERROR = 0x8, TRUST_LOWERED = 0x9, UNKNOWN_ERROR = 0x10,
	    CORRECT = (byte) 0xFF;
